...
avagent_cmd_register()
{
    ...
    echo "This script will register and activate the client with the Administrator server (bo1ave01)."

    UNREGISTERED=1
    MCSADDR="bo1ave01.csnzoo.com"
    while [ ${UNREGISTERED} -ne 0 ]
    do
      DPNDOMAIN="clients/desktop"
      MCSGROUPLIST="/clients/desktop/US-East-Apple"
      ...
      echo "Added domain [/clients/desktop]"
      ...
      echo "Added Group [US East - Apple]"
      # Register with MCS
