...
volname="Flash"
logfile="/Library/Logs/FlashRemoveScript.log"
...
if [ "${currentinstalledver}" ]; then
 ...
 cd /Volumes/Flash\ Player/Adobe\ Flash\ Player\ Uninstaller.app/Contents/MacOS/Adobe\ Flash\ Player\ Install\ Manager -uninstall> /dev/null
 /bin/sleep 10
